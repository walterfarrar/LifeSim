...
export function expressPlant(dna: DNA): PlantTraits {
  ...
  return {
    ...
    maxEnergy,
    growthRate: 0.12 + g(PlantGene.GrowthRate) * 0.58,
    spreadMin: 10 + g(PlantGene.SpreadMin) * 45,
    spreadMax: 45 + g(PlantGene.SpreadMax) * 95,
    maturationAge: 180 + g(PlantGene.Maturation) * 820,
    spreadAgeBonus: 60 + g(PlantGene.SpreadMax) * 160,
    reproductionRate: 0.3 + g(PlantGene.Reproduction) * 1.4,
